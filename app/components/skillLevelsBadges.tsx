  ...
  return (
    <Card isFooterBlurred className="border-none" radius="lg">
      <Image
        ...
        width={200}
      />
      <CardFooter className={`justify-between before:${backgroundColorClass}/10 border-white/20 border-1 overflow-hidden py-1 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10`}>
